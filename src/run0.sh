...
CUDA_VISIBLE_DEVICES=2 python track.py mot --load_model /home/zhouchengyu/paper1/others/fairmot_dla34.pth --conf_thres 0.2 --val_mot20 True --experiments mot20_test_val_0.2_0.3 --chance test5 
